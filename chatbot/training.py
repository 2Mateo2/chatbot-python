...
words = [lemmatizer.stem(word.lower()) for word in words if word not in ignore_letters]
...
for document in documents:
    ...
    word_patterns = [lemmatizer.stem(word.lower()) for word in word_patterns]
...
model.save("./chatbot/chatbot_model.h5", train_process)
